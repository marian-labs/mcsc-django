...
SUPABASE_PROJECT_REF = SUPABASE_URL.split('//')[-1].split('.')[0] if SUPABASE_URL else ''
AWS_ACCESS_KEY_ID = config('AWS_ACCESS_KEY_ID', default=config('SUPABASE_ACCESS_KEY_ID', default=SUPABASE_PROJECT_REF))
